...
export const dinnerData = [
  ...
  { name: 'Pasta al limone', emoji: '🍝', tags: ['pasta', 'vegetar', 'rask'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'Matprat: Pasta al limone', url: 'https://www.matprat.no/oppskrifter/kos/pasta-al-limone/'}, {name: 'Oda: Pasta al limone', url: 'https://oda.com/no/recipes/4122-silje-feiring-pasta-al-limone/'}] },
