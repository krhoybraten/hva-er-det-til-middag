...
export const dinnerData = [
  ...
  { name: 'Wok', emoji: '🥢', tags: ['svinekjøtt', 'oksekjøtt', 'kylling', 'vegetar'], likedBy: likedBy(), recipeUrls: [{name: 'Godt.no: Nudler kylling kung pao', url: 'https://www.godt.no/oppskrifter/wok/9197/nudler-kylling-kung-pao'}, {name: 'Godt.no: Nudler med masse grønnsaker', url: 'https://www.godt.no/oppskrifter/wok/2319/nudler-med-masse-groennsaker'}] },
