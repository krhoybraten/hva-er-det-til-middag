...
export const dinnerData = [
  ...
  { name: 'Pasta med røkt skinke og soltørkede tomater', emoji: '🍝', tags: ['pasta', 'svinekjøtt', 'rask'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'Matprat: Pasta med røkt skinke og soltørkede tomater', url: 'https://www.matprat.no/oppskrifter/rask/pasta-med-rokt-skinke-og-soltorkede-tomater/'}] },
  ...
  { name: 'Kylling i pita', emoji: '🥙', tags: ['kylling'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Matprat: Kyllingfilet i grove pitabrød', url: 'https://www.matprat.no/oppskrifter/sunn/kyllingfilet-i-grove-pitabrod/'}, {name: 'Matprat: Kylling i pita', url: 'https://www.matprat.no/oppskrifter/familien/kylling-i-pita/'}] },
  { name: 'Kyllingwraps', emoji: '🌯', tags: ['kylling', 'rask'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Matprat: Kyllingfilet i tortillaslefse', url: 'https://www.matprat.no/oppskrifter/rask/kyllingfilet-i-tortillaslefse/'}] },
  ...
  { name: 'Nachos', emoji: '🧀', tags: ['oksekjøtt', 'helg', 'rask'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Matprat: Kylling- og tortillasnacks', url: 'https://www.matprat.no/oppskrifter/kos/kylling--og-tortillasnacks/'}] },
  ...
  { name: 'Wok', emoji: '🥢', tags: ['oksekjøtt', 'kylling', 'fisk', 'vegetar', 'rask'], likedBy: likedBy(), recipeUrls: [{name: 'Godt.no: Nudler kylling kung pao', url: 'https://www.godt.no/oppskrifter/wok/9197/nudler-kylling-kung-pao'}, {name: 'Godt.no: Nudler med masse grønnsaker', url: 'https://www.godt.no/oppskrifter/wok/2319/nudler-med-masse-groennsaker'}, {name: 'Godt.no: Asiatisk biff på 1-2-3', url: 'https://www.godt.no/oppskrifter/wok/1310/asiatisk-biff-paa-1-2-3'}, {name: 'Matprat: Laks i wok', url: 'https://www.matprat.no/oppskrifter/familien/laks-i-wok/'}, {name: 'Matprat: Kyllingwok med fullkornsnudler', url: 'https://www.matprat.no/oppskrifter/sunn/kyllingwok-med-fullkornsnudler/'}, {name: 'Matprat: Biffwok med kål og peanøtter', url: 'https://www.matprat.no/oppskrifter/sunn/biffwok-med-kal-og-peanotter/'}] },
