...
export const dinnerData = [
  ...
  { name: 'Wrap med fiskepinner', emoji: '🌯', tags: ['fisk', 'rask'], likedBy: likedBy(SLOTH, FLYING_SQUIRREL), recipeUrls: [{name: 'Oda: Rask wrap med fiskepinner', url: 'https://oda.com/no/recipes/3615-oda-rask-wrap-med-fiskepinner/'}] },
  { name: 'Fiskeburger', emoji: '🍔', tags: ['fisk', 'rask', 'grill'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Godt.no: Lakseburger med parmesankrem og søtpotetfries', url: 'https://www.godt.no/oppskrifter/burger/9224/lakseburger-med-parmesankrem-og-soetpotetfries'}, {name: 'MENY: Fiskeburger med røkelaks og rødløk', url: 'https://meny.no/oppskrifter/burger/fiskeburger-med-rokelaks-og-rodlok'}, {name: 'MENY: Lakseburger med mango', url: 'https://meny.no/oppskrifter/burger/lakseburger-med-mango'}, {name: 'MENY: Fiskeburger med enkel coleslaw', url: 'https://meny.no/oppskrifter/burger/fiskeburger-med-enkel-coleslaw'}, {name: 'MENY: Lakseburger med tzatziki', url: 'https://meny.no/oppskrifter/burger/lakseburger-med-tzatziki'}, {name: 'MENY: Fiskeburger med guacamole og mango', url: 'https://meny.no/oppskrifter/burger/fiskeburger-med-guacamole-og-mango'}] },
  ...
  { name: 'Pasta al limone', emoji: '🍝', tags: ['pasta', 'vegetar', 'rask'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'Matprat: Pasta al limone', url: 'https://www.matprat.no/oppskrifter/kos/pasta-al-limone/'}, {name: 'Oda: Pasta al limone', url: 'https://oda.com/no/recipes/4122-silje-feiring-pasta-al-limone/'}, {name: 'MENY: Pasta al limone', url: 'https://meny.no/oppskrifter/pasta/pasta-al-limone'}] },
  { name: 'Pasta med kremet tomatsaus', emoji: '🍝', tags: ['pasta', 'vegetar', 'rask'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'REMA 1000: Pasta med kremet tomatsaus', url: 'https://www.rema.no/oppskrifter/pasta/pasta-med-kremet-tomatsaus/'}] },
  { name: 'Pasta med biff og brokkoli', emoji: '🍝', tags: ['pasta', 'oksekjøtt'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'REMA 1000: Pasta med biff og brokkoli', url: 'https://www.rema.no/oppskrifter/pasta/pasta-med-biff-og-brokkoli/'}] },
  { name: 'Kremet pasta med kylling', emoji: '🍝', tags: ['pasta', 'kylling'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'MENY: Kremet pasta med kylling', url: 'https://meny.no/oppskrifter/pasta/kremet-pasta-med-kylling'}, {name: 'REMA 1000: Pasta med kylling og kremet saus', url: 'https://www.rema.no/oppskrifter/pasta/pasta-med-kylling-og-kremet-saus/'}] },
  { name: 'Mac and cheese med kjøttdeig', emoji: '🍝', tags: ['pasta', 'oksekjøtt', 'rask'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'REMA 1000: Mac and cheese med kjøttdeig', url: 'https://www.rema.no/oppskrifter/kjottdeig/mac-and-cheese-med-kjottdeig/'}] },
  ...
  { name: 'Kyllingwraps', emoji: '🌯', tags: ['kylling', 'rask'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Matprat: Kyllingfilet i tortillaslefse', url: 'https://www.matprat.no/oppskrifter/rask/kyllingfilet-i-tortillaslefse/'}, {name: 'MENY: Grove wraps med kylling og mango', url: 'https://meny.no/oppskrifter/kylling/grove-wraps-med-kylling-og-mango'}] },
  { name: 'Kremet sitronkylling med ris', emoji: '🍗', tags: ['kylling', 'ris', 'rask'], likedBy: likedBy(), recipeUrls: [{name: 'Oda: Kremet sitronkylling med ris', url: 'https://oda.com/no/recipes/4840-silje-feiring-kremet-sitronkylling-med-ris/'}] },
  ...
  { name: 'Wok', emoji: '🥢', tags: ['oksekjøtt', 'kylling', 'fisk', 'vegetar', 'rask', 'svinekjøtt'], likedBy: likedBy(), recipeUrls: [{name: 'Godt.no: Nudler kylling kung pao', url: 'https://www.godt.no/oppskrifter/wok/9197/nudler-kylling-kung-pao'}, {name: 'Godt.no: Nudler med masse grønnsaker', url: 'https://www.godt.no/oppskrifter/wok/2319/nudler-med-masse-groennsaker'}, {name: 'Godt.no: Asiatisk biff på 1-2-3', url: 'https://www.godt.no/oppskrifter/wok/1310/asiatisk-biff-paa-1-2-3'}, {name: 'Matprat: Laks i wok', url: 'https://www.matprat.no/oppskrifter/familien/laks-i-wok/'}, {name: 'Matprat: Kyllingwok med fullkornsnudler', url: 'https://www.matprat.no/oppskrifter/sunn/kyllingwok-med-fullkornsnudler/'}, {name: 'MENY: Kyllingwok med hoisinsaus', url: 'https://meny.no/oppskrifter/wok/kyllingwok-med-hoisinsaus'}, {name: 'MENY: Laksewok med nudler', url: 'https://meny.no/oppskrifter/wok/laksewok-med-nudler'}, {name: 'Matprat: Biffwok med kål og peanøtter', url: 'https://www.matprat.no/oppskrifter/sunn/biffwok-med-kal-og-peanotter/'}, {name: 'Oda: Rask wok med svin og risnudler', url: 'https://oda.com/no/recipes/3618-silje-feiring-rask-wok-med-svin-og-risnudler/'}] },
  { name: 'Stekt ris', emoji: '🍚', tags: ['oksekjøtt', 'ris', 'rask', 'vegetar'], likedBy: likedBy(SLOTH, KANGAROO, FLYING_SQUIRREL), recipeUrls: [{name: 'Godt.no: Stekt ris med kjøttdeig', url: 'https://www.godt.no/oppskrifter/ris/12929/stekt-ris-med-kjoettdeig'}, {name: 'Matprat: Stekt ris med kylling', url: 'https://www.matprat.no/oppskrifter/rask/stekt-ris-med-kylling/'}, {name: 'MENY: Stekt ris med egg og kylling', url: 'https://meny.no/oppskrifter/ris/stekt-ris-med-egg-og-kylling'}, {name: 'REMA 1000: Stekt ris med grønnsaker', url: 'https://www.rema.no/oppskrifter/ris/stekt-ris-med-gronnsaker/'}] },
