...
export const dinnerData = [
  ...
  { name: 'Kremet pasta med kylling', emoji: '🍝', tags: ['pasta', 'kylling'], likedBy: likedBy(SLOTH, KANGAROO), recipeUrls: [{name: 'MENY: Kremet pasta med kylling', url: 'https://meny.no/oppskrifter/pasta/kremet-pasta-med-kylling'}] },
